...
> {
  ...
  public render () {
    ...
    const dataWranglerUrl = `http://127.0.0.1:8315/#/sheet/add?simpleMode=true&showBottomBar=false&readOnly=true&showChangeModeButton=false&visualisData=${JSON.stringify(visualisData)}`
    return (
